...
static const char* SNSService_method_names[] = {
  "/csce438.SNSService/Register",
  "/csce438.SNSService/Report",
  "/csce438.SNSService/Login",
  "/csce438.SNSService/List",
  "/csce438.SNSService/Follow",
  "/csce438.SNSService/UnFollow",
  "/csce438.SNSService/Subscription",
  "/csce438.SNSService/Gettime",
...
SNSService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_Register_(SNSService_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Report_(SNSService_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Login_(SNSService_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_List_(SNSService_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Follow_(SNSService_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UnFollow_(SNSService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Subscription_(SNSService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Gettime_(SNSService_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Timeline_(SNSService_method_names[8], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}

::grpc::Status SNSService::Stub::Register(::grpc::ClientContext* context, const ::csce438::Regmessage& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Register_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::AsyncRegisterRaw(::grpc::ClientContext* context, const ::csce438::Regmessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::Reply>::Create(channel_.get(), cq, rpcmethod_Register_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::PrepareAsyncRegisterRaw(::grpc::ClientContext* context, const ::csce438::Regmessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::Reply>::Create(channel_.get(), cq, rpcmethod_Register_, context, request, false);
}

::grpc::Status SNSService::Stub::Report(::grpc::ClientContext* context, const ::csce438::Regmessage& request, ::csce438::Reply* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Report_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::AsyncReportRaw(::grpc::ClientContext* context, const ::csce438::Regmessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::Reply>::Create(channel_.get(), cq, rpcmethod_Report_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::csce438::Reply>* SNSService::Stub::PrepareAsyncReportRaw(::grpc::ClientContext* context, const ::csce438::Regmessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::Reply>::Create(channel_.get(), cq, rpcmethod_Report_, context, request, false);
}
...
::grpc::Status SNSService::Stub::Subscription(::grpc::ClientContext* context, const ::csce438::Request& request, ::csce438::ListReply* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Subscription_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::csce438::ListReply>* SNSService::Stub::AsyncSubscriptionRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::ListReply>::Create(channel_.get(), cq, rpcmethod_Subscription_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::csce438::ListReply>* SNSService::Stub::PrepareAsyncSubscriptionRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::ListReply>::Create(channel_.get(), cq, rpcmethod_Subscription_, context, request, false);
}

::grpc::Status SNSService::Stub::Gettime(::grpc::ClientContext* context, const ::csce438::Request& request, ::csce438::Message* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Gettime_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::csce438::Message>* SNSService::Stub::AsyncGettimeRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::Message>::Create(channel_.get(), cq, rpcmethod_Gettime_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::csce438::Message>* SNSService::Stub::PrepareAsyncGettimeRaw(::grpc::ClientContext* context, const ::csce438::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::csce438::Message>::Create(channel_.get(), cq, rpcmethod_Gettime_, context, request, false);
}
...
SNSService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce438::Regmessage, ::csce438::Reply>(
          std::mem_fn(&SNSService::Service::Register), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SNSService_method_names[1],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce438::Regmessage, ::csce438::Reply>(
          std::mem_fn(&SNSService::Service::Report), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce438::Request, ::csce438::ListReply>(
          std::mem_fn(&SNSService::Service::Subscription), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      SNSService_method_names[7],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SNSService::Service, ::csce438::Request, ::csce438::Message>(
          std::mem_fn(&SNSService::Service::Gettime), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status SNSService::Service::Register(::grpc::ServerContext* context, const ::csce438::Regmessage* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status SNSService::Service::Report(::grpc::ServerContext* context, const ::csce438::Regmessage* request, ::csce438::Reply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SNSService::Service::Subscription(::grpc::ServerContext* context, const ::csce438::Request* request, ::csce438::ListReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SNSService::Service::Gettime(::grpc::ServerContext* context, const ::csce438::Request* request, ::csce438::Message* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
